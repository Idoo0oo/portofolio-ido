<template>
  <main
    ...
    <div class="space-y-2 text-center md:text-left px-10">
      <p class="text-[#70dbff]">Hello World, I'm</p>
      <h1 class="text-4xl font-bold md:text-5xl text-white fadein-up">Muhammad Ditto</h1>
      <div class="py-2">
        <h1
          class="typewrite text-xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-slate-100 to-[#70dbff] md:text-2xl fadein-up"
          ref="typewriter">
    ...
    <div class="flex justify-center md:justify-start fadein-right"><img alt="avatar" fetchpriority="high" width="300" height="300" decoding="async" data-nimg="1"
        class="w-8/10 md:h-auto rounded-full border-4 border-[#70dbff] pict" src="../assets/img/pp3.png">
    </div>
  </main>
</template>
<script>
export default {
  ...
  data() {
    return {
      toRotate: ["Web Developer", "Full-stack Engineer", "Pacarnya Bellskiee<33", "SMKN 4 Kota Tangerang Student", "Tech Enthusiast", "UI/UX Designer", "Video Editing"],
      period: 2000,
      txt: '',
      loopNum: 0,
      isDeleting: false,

    ...
    <div class="flex flex-col-reverse md:flex-row relative">
            ...
            <router-link :to="`/read/${article.slug}/${article.id}`" class="flex w-full bg-[#1e1e1f] border-[#383838] rounded-xl text-left text-white p-5 md:py-7 md:px-8 cursor-pointer hover:bg-[#282828] items-center">
              <div class="w-full pr-4">
                <div class="text-xs mb-1 text-slate-400 flex items-center italic">
                  <div class="h-[1px] w-20 bg-[#70dbff] md:w-5 aos-init aos-animate mr-2"></div> {{ article.date }}
                </div>
                <h1 class="text-sm md:text-md text-[#70dbff] font-bold mb-2 paraf">{{ article.title }}</h1>
      ...
      <div class="w-full md:w-1/3 h-fit p-8 md:sticky md:top-24">
        ...
        <div class="flex flex-col text-left">
          <div class="bg-clip-text bg-gradient-to-r from-slate-100 to-[#70dbff] text-transparent">Let's share experiences,
            stories, and knowledge together.
          </div>
          <div class="h-[1px] mt-7 mb-7 w-20 bg-[#70dbff] aos-init aos-animate mr-2"></div>
          <div class="hidden md:block">
            ...
            <!-- <div class="h-[1px] mt-7 mb-7 w-20 bg-w-32 md:w-48 aos-init aos-animate mr-2"></div>
